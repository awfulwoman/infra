...
**Roles modified**:
- `ansible/roles/system-zfs/tasks/main.yaml` - Major refactoring and improvements:
...
- `ansible/roles/system-zfs/defaults/main.yaml` - Cleanup (2 deletions)
- `ansible/roles/system-zfs/templates/zfs-load-key.service` - Moved from system-zfs-new
- `ansible/roles/compositions/tasks/main.yaml` - Variable updates
- `ansible/roles/compositions/defaults/main.yaml` - Added compositions_dataset default

**Roles deleted**:
- `ansible/roles/system-zfs-new/` - Entire role removed (README, defaults, tasks)

**Composition roles updated**:
- `ansible/roles/composition-awfulwoman/templates/docker-compose.yaml.j2`
- `ansible/roles/composition-get-iplayer/tasks/main.yaml`
- `ansible/roles/composition-get-iplayer/templates/docker-compose.yaml.j2`
- `ansible/roles/composition-immich/defaults/main.yaml`
- `ansible/roles/composition-immich/templates/.env`
- `ansible/roles/composition-tubesync/templates/docker-compose.yaml.j2`
...
- `ansible/inventory/host_vars/host-storage/core.yaml` (79 lines removed)
- `ansible/inventory/host_vars/vm-awfulwoman/core.yaml`
