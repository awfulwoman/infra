...
- **Enhanced Terraform DNS template** to support dynamic resource references
  - Modified `/Users/charlie/Code/infra/ansible/roles/infra-public-resources/templates/hetzner.tf` (around line 42)
...
- **Implemented floating IP binding in virtual-hetzner role**
  - Created tasks in `/Users/charlie/Code/infra/ansible/roles/virtual-hetzner/tasks/main.yaml`
...
- `/Users/charlie/Code/infra/ansible/roles/infra-public-resources/templates/hetzner.tf` - Modified DNS record value output logic
- `/Users/charlie/Code/infra/ansible/roles/virtual-hetzner/tasks/main.yaml` - Added floating IP configuration tasks
- `/Users/charlie/Code/infra/ansible/playbooks/virtual/vm-awfulwoman-hetzner/` - Renamed from `vm-awfulwoman` (entire directory)
- `/Users/charlie/Code/infra/ansible/playbooks/virtual/compositions.yaml` - Updated to reference new directory
- `/Users/charlie/Code/infra/ansible/playbooks/virtual/core.yaml` - Updated to reference new directory
- `/Users/charlie/Code/infra/ansible/roles/infra-public-resources/defaults/main/hetzner.yaml` - Added Hetzner resource definitions
