...
**Modified files**:
- `ansible/plugins/filters/zfs_datasets.py` - Added `zfs_datasets_with_importance` filter
- `ansible/roles/backups-zfs-client/tasks/main.yaml` - Removed Sanoid tasks
- `ansible/roles/backups-zfs-client/templates/sanoid.conf.j2` - Deleted
- `docs/ZFS.md` - Added backup destinations to policy table
