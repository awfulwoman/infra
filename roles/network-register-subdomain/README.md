...
| `configure_dns_domain` | `{{ domain_name }}` | The DNS zone to register records in |
...
- The `domain_name` variable is a global group var used throughout the repo, so `configure_dns_domain` rarely needs to be overridden.
