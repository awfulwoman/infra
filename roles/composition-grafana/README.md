...
Add to `inventory/group_vars/infra/vault_compositions.yaml`:
...
Add to `inventory/group_vars/infra/vault_misc.yaml` for alerting:
...
ansible-playbook playbooks/baremetal/host-storage/victoriametrics.yaml
```
