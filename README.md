...
I use it in a way where I understand the code and config that it creates, and I absolutely refuse to engage in rampant "vibe coding" (which is truly a manifestation of mediocrity if ever there was one). Claude has proved useful for writing informative and detailed commit messages, and has forced me to start documenting everything here.
