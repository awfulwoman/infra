...
When committing any files you must expect that this package will be run via a git pre-commit hook.

If any errors are shown you should fix them before committing again.
