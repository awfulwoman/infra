...
## January 12, 2026 - Hetzner Cloud Terraform Template Improvements
...
**Modified files**:
- `/Users/charlie/Code/infra/ansible/inventory/group_vars/infra/core.yaml` - Added Hetzner API token to environment
- `/Users/charlie/Code/infra/ansible/roles/infra-public-resources/defaults/main/main.yaml` - Main defaults entry point
- `/Users/charlie/Code/infra/ansible/roles/infra-public-resources/defaults/main/digital_ocean.yaml` - DigitalOcean-specific defaults
- `/Users/charlie/Code/infra/ansible/roles/infra-public-resources/defaults/main/hetzner.yaml` - Hetzner-specific defaults
- `/Users/charlie/Code/infra/ansible/roles/infra-public-resources/tasks/main.yaml` - Updated for new defaults structure
- `/Users/charlie/Code/infra/ansible/roles/infra-public-resources/templates/digitalocean.tf` - DigitalOcean resources
- `/Users/charlie/Code/infra/ansible/roles/infra-public-resources/templates/hetzner.tf` - Hetzner resources (major DNS refactor)
- `/Users/charlie/Code/infra/ansible/roles/infra-public-resources/templates/main.tf` - Main Terraform config
- `/Users/charlie/Code/infra/ansible/roles/infra-public-resources/templates/variables.tf` - Added Hetzner token variable
- `/Users/charlie/Code/infra/ansible/roles/infra-public-resources/templates/versions.tf` - Added Hetzner provider version

**Deleted files**:
- `/Users/charlie/Code/infra/ansible/roles/infra-public-resources/defaults/main.yaml` - Replaced with directory structure
...
- Firewall issues documented in issue 74 but not yet resolved
- Working directory clean (all changes committed and pushed)

### Next Steps

1. **Address firewall issues in follow-up work**:
   - Fix variable reference: use `infra_publicresources_hcloud_firewall` instead of DigitalOcean variable
   - Add `apply_to` blocks to explicitly attach firewalls to resources
   - Fix outbound rule IPs: change `source_ips` to `destination_ips`
...
**Firewall issues identified (not yet fixed)**:
```hcl
...
## January 6, 2026 - ZFS Snapshot Report Tool and Critical Prune Bug Fix
...
**New files**:
- `/Users/charlie/Code/infra/ansible/roles/system-zfs-policy/templates/zfs-snapshot-report.py.j2` (184 lines)

**Modified files**:
- `/Users/charlie/Code/infra/ansible/roles/system-zfs-policy/templates/zfs-prune.py.j2` - Fixed regex f-string bug
- `/Users/charlie/Code/infra/ansible/roles/system-zfs-policy/tasks/main.yaml` - Added deployment tasks for report script and PATH configuration
- `/Users/charlie/Code/infra/ansible/plugins/filters/zfs_datasets.py` - Added inheritance support to filter
...
## January 5, 2026 - Policy-Driven ZFS Snapshot System Implementation
